...
export class News extends Component {
    ...
    handlePress = () => {
        //Aquí se llama a la api y se consigue la descripción con la id pasada por props o se le pasa por props 
        //también directamente (O se tiene todas las noticias con su descrpción o se pide cuando se necesite ¿?)
